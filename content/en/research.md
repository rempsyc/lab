...
This program studies how people understand and care for others, how identities and group boundaries shape behaviour, and how psychological interventions can reduce aggression, prejudice, and polarization. Our work has examined virtual body-swapping as a way to increase empathy and loving-kindness books as a durable intervention for prosocial change.

Current research uses artificial intelligence to identify promising nonfiction books and then tests their effects in large human studies. Looking ahead, we aim to understand how inclusive identities, sustained engagement, social networks, and different media environments can foster social harmony in schools, communities, and society.
...
Open science supports how we conduct research across the lab and also forms a smaller research stream of its own. We examine replicability, research practices, statistical methods, artificial intelligence, and metascience. We develop tools and contribute to large collaborative projects that test the robustness of published findings and improve the analysis of quantitative and qualitative data.

We also study whose knowledge is represented in behavioural science. This includes documenting the underrepresentation of researchers and populations from the Global South and identifying practices that lead scientists to make overly broad claims from narrow evidence.

## An interdisciplinary toolkit

Across these programs, we combine experiments and randomized controlled trials with artificial intelligence, virtual reality, big data, contemplative practices, nonfiction books, qualitative analysis, and social network methods. These tools allow us to study both immediate psychological processes and changes that unfold through sustained engagement over time.
