...
The proposed [SAGE Community](../community/) offers another way to connect: discussion, peer learning, and a sense of belonging without an implied research placement. It is valuable in its own right. Projects may sometimes emerge from these connections, but they require their own agreement and supervision arrangements. Joining is not an audition, and it does not replace a clear answer to an existing research application.
